...
export type FeasibilityView =
  | { readonly state: "ready"; readonly title: string; readonly context: string; readonly policyName: string; readonly languages: readonly { readonly code: string; readonly required: boolean }[]; readonly providers: readonly { readonly provider: string; readonly status: string; readonly detail: string; readonly cacheStatus?: "hit" | "miss" }[]; readonly releases: readonly FeasibilityReleaseRow[] }
