...
```console
cp .env.example .env
# Set PEGARR_IMAGE=ghcr.io/squiter/pegarr:0.1.1 in .env
...
- [Latest release notes](docs/releases/v0.1.1.md), [v0.1.0 notes](docs/releases/v0.1.0.md), and [changelog](CHANGELOG.md)
