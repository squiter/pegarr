...
```console
cp .env.example .env
# Set PEGARR_IMAGE=ghcr.io/squiter/pegarr:0.1.4 in .env
...
- [Latest release notes](docs/releases/v0.1.4.md), [v0.1.3 notes](docs/releases/v0.1.3.md), and [changelog](CHANGELOG.md)
