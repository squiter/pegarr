...
Release rows retain safe Arr comparison evidence such as size, age, peers, language/custom-format names, and release traits. Download URLs and magnet handles are discarded before report construction.
