...
Installed Sonarr, Radarr, Bazarr policy, SubDL, and OpenSubtitles compatibility are now live-proven. The remaining controlled-Grab boundary is not repaired with private fixtures, hidden network calls, or a false green label.
