...
- Next: add a separately confirmed season-pack controlled Grab path without weakening the existing exact-episode and administrator boundaries.
- Not yet implemented: automatic-search suppression verification against live Arr and season-pack controlled Grab. No continuation can silently Grab.
