...
- Installed Sonarr add-to-exact-analysis compatibility and automatic-search suppression are verified. The equivalent installed Radarr path and an operator-owned controlled Grab remain explicit manual boundaries. No continuation can silently Grab.
