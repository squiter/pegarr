...
The signed `v0.1.4` release at commit `2ed900e2c6aa21b2f2cf344883be5b9228f8e766` was then published and pinned in Portainer at `ghcr.io/squiter/pegarr@sha256:ce149b54a9536d7c2a488f4749b2e28af6f1996c6988a71619d0c5fb959d51ed`. Portainer changed only the Pegarr digest in the preserved 5,277-character stack definition. Container `a4cd08985eddc0e4c847229e72e44a9ce819a0d826f62b80b061201a8b5439e9` became healthy at version `0.1.4` and the exact release revision. All six sibling containers retained their earlier creation times and running state. HTTPS readiness returned `ready`; reloading the existing Pegarr tab remained signed in and restored the ready settings state, discovery, and 51-item inventory. No provider search, catalog add, automatic search, controlled Grab, or download mutation ran during this deployment.
